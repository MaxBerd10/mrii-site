...
const COL_HREFS = ['/clinic', '/research', '/education', '/ai', '/partners']

const SOCIALS = [
  { label: 'Telegram', href: 'https://t.me/', path: 'M21.5 4.3 2.9 11.4c-1.1.4-1.1 1.1-.2 1.4l4.7 1.5 1.8 5.5c.2.6.4.8 1 .8.4 0 .6-.2.9-.5l2.3-2.2 4.7 3.5c.9.5 1.5.2 1.7-.8l3.1-14.5c.3-1.2-.5-1.8-1.4-1.4z' },
