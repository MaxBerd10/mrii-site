...
export const newsArticles: NewsArticle[] = [
  {
    ...
    content: {
      uz: {
        lead: 'MRII I-bosqich bo‘limi CAR-T terapiyasi bo‘yicha xalqaro ko‘p markazli tadqiqotda birinchi bemorlarni qabul qilishni boshladi.',
        body: [
          ...
          'Birinchi bemorlar to‘liq diagnostika, laboratoriya monitoringi va 24/7 klinik kuzatuv ostida qabul qilinmoqda. MRII jamoasi sponsorlar, CRO hamkorlari va klinik laboratoriyalar bilan yagona raqamli tizim orqali ishlaydi.',
      ...
      ru: {
        lead: 'Отделение I фазы MRII начало набор первых пациентов в международное исследование CAR-T терапии.',
        body: [
          ...
          'Первые пациенты принимаются при полном диагностическом сопровождении, лабораторном мониторинге и круглосуточном клиническом наблюдении. Команда MRII работает со спонсорами и CRO в единой цифровой системе.',
      ...
      en: {
        lead: 'MRII’s Phase I unit has started enrolling the first patients in an international multi-center CAR-T therapy study.',
        body: [
          ...
          'First patients are admitted with full diagnostics, laboratory monitoring, and 24/7 clinical observation. MRII collaborates with sponsors and CRO partners through one digital system.',
    ...
    content: {
      uz: {
        ...
        body: [
          ...
          'MRII diagnostika markazida tizim mavjud ish jarayoniga integratsiya qilinadi: skanerlash, tahlil, xulosa va davolovchi shifokorga uzatish yagona zanjirda qoladi.',
      ...
      ru: {
        ...
        body: [
          ...
          'В диагностическом центре MRII система встраивается в текущий процесс: сканирование, анализ, заключение и передача лечащему врачу остаются в одной цепочке.',
      ...
      en: {
        ...
        body: [
          ...
          'At the MRII diagnostics center, the system integrates into the existing workflow so scanning, analysis, reporting, and physician handoff stay in one chain.',
  ...
  },
  {
    ...
    content: {
      uz: {
        lead: 'MRII akademiyasi 2025–2027 o‘quv davriga ordinaturaga ariza qabul qilmoqda: 8 ixtisoslikda jami 48 o‘rin ochiq.',
        body: [
      ...
      ru: {
        lead: 'Академия MRII открыла набор в ординатуру на 2025–2027 учебный период: 48 мест по 8 специальностям.',
        body: [
      ...
      en: {
        lead: 'MRII Academy is accepting residency applications for 2025–2027: 48 seats across 8 specialties.',
        body: [
