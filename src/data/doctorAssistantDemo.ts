...
> = {
  ...
  ru: {
    ...
    modePhysician: 'Врач',
    backAi: 'AI-решения',
    intakeLead: 'Заполните анкету — AiShifokor сразу даст предварительный разбор, затем врач подтвердит.',
  ...
  en: {
    ...
    backAi: 'AI solutions',
    intakeLead: 'Fill the intake — AiShifokor drafts an analysis immediately, then a doctor confirms.',
...
export function buildPatientAiAnalysis(
  ...
  const fullText = [
    lang === 'ru' ? 'AiShifokor — предварительный разбор' : lang === 'en' ? 'AiShifokor — preliminary analysis' : 'AiShifokor — dastlabki tahlil',
    '',
    summary,
    '',
    urgency,
