...
class Command(BaseCommand):
    ...
    def seed_ai(self):
        ...
        # Only doctor-assistant (AiShifokor) is ever rendered — AISection.tsx
        # shows just the first product. Drop any other seeded/legacy rows.
        models.AIProduct.objects.exclude(slug='doctor-assistant').delete()
